...
var class_link = "linkRed10";
var class_text = "txtBlack10";
...
Calendar.prototype.getMonthlyCalendarCode = function() {
	...
	vCode += ("<div align=center><TABLE BORDER=0 CELLSPACING=1 BGCOLOR=\"" + this.gBGColor + "\" style='font-size:" + fontsize + "pt;'>");
...
Calendar.prototype.show = function() {
	...
	ggWinContent += ("<TABLE WIDTH='100%' BORDER=0 CELLSPACING=0 CELLPADDING=0 BGCOLOR='#EEEEEE' style='font-size:" + fontsize + "pt;'><TR><TD ALIGN=center>");
	ggWinContent += ("<A CLASS='"+ class_link +"' HREF=\"javascript:void(0);\" " +
		"onMouseOver=\"window.status='Vai indietro di un anno'; return true;\" " +
	...
	ggWinContent += ("<A CLASS='"+ class_link +"' HREF=\"javascript:void(0);\" " +
		"onMouseOver=\"window.status='Vai indietro di un mese'; return true;\" " +
		"onMouseOut=\"window.status=''; return true;\" " +
		"onClick=\"Build(" + 
	...
	ggWinContent += ("<A CLASS='"+ class_link +"' HREF=\"javascript:void(0);\" " +
		"onMouseOver=\"window.status='Vai avanti di un mese'; return true;\" " +
		"onMouseOut=\"window.status=''; return true;\" " +
		"onClick=\"Build(" + 
		...
		"\">&gt;<\/A></TD><TD ALIGN=center>");
	ggWinContent += ("<A CLASS='"+ class_link +"' HREF=\"javascript:void(0);\" " +
		"onMouseOver=\"window.status='Vai avanti di un anno'; return true;\" " +
		"onMouseOut=\"window.status=''; return true;\" " +
		"onClick=\"Build(" + 
		"'" + this.gReturnItem + "', '" + this.gMonth + "', '" + (parseInt(this.gYear)+1) + "', '" + this.gFormat + "'" +
		");" +
...
Calendar.prototype.cal_header = function() {
	...
	vCode = vCode + "<TR>";
	vCode = vCode + "<TD WIDTH='14%'><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>D</B></FONT></TD>";
	vCode = vCode + "<TD WIDTH='14%'><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>L</B></FONT></TD>";
	vCode = vCode + "<TD WIDTH='14%'><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>M</B></FONT></TD>";
	vCode = vCode + "<TD WIDTH='14%'><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>M</B></FONT></TD>";
	vCode = vCode + "<TD WIDTH='14%'><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>G</B></FONT></TD>";
	vCode = vCode + "<TD WIDTH='14%'><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>V</B></FONT></TD>";
	...
	*/
	...
	for (j=vFirstDay; j<7; j++) {
		vCode = vCode + "<TD WIDTH='14%'" + this.write_weekend_string(j) + "><FONT FACE='" + fontface + "'>" + 
			"<A CLASS='" + class_link +"' HREF='javascript:void(0);' " + 
				"onMouseOver=\"window.status='setta la data a " + this.format_data(vDay) + "'; return true;\" " +
				"onMouseOut=\"window.status=' '; return true;\" " +
	...
	//Qui ci sono i colori dei giorni che ricadono nel mese successivo 
	for (m=1; m<(7-j); m++) {
		if (this.gYearly)
			vCode = vCode + "<TD WIDTH='14%'" + this.write_weekend_string(j+m) + 
			"><FONT FACE='" + fontface + "' COLOR='#FFFFFF'> </FONT></TD>";
		else
			vCode = vCode + "<TD WIDTH='14%'" + this.write_weekend_string(j+m) + 
			"><FONT FACE='" + fontface + "' COLOR='#FFFFFF'>" + m + "</FONT></TD>";
	}
...
Calendar.prototype.format_day = function(vday) {
	...
	if (vday == vNowDay && this.gMonth == vNowMonth && this.gYear == vNowYear)
		return ("<FONT COLOR=\"#F2F2F2\"><B>" + vday + "</B></FONT>");
	else
		return (vday);
}
...
function Build(p_item, p_month, p_year, p_format) {
	...
	gCal.gLinkColor="#333333";
	gCal.gTextColor="#333333";
	...
	if (ggPosX == -1 && ggPosY == -1) {
		overlib(ggWinContent, AUTOSTATUSCAP, STICKY, CLOSECLICK, CSSSTYLE,
			...
			CAPTION, "Seleziona la data", OFFSETX, 20, OFFSETY, -20);
		...
		overlib(ggWinContent, AUTOSTATUSCAP, STICKY, CLOSECLICK, CSSSTYLE,
			TEXTSIZEUNIT, "pt", TEXTSIZE, 8, CAPTIONSIZEUNIT, "pt", CAPTIONSIZE, 8, CLOSESIZEUNIT, "pt", CLOSESIZE, 8,
			CAPTION, "Seleziona la data", FIXX, ggPosX, FIXY, ggPosY);
		}
